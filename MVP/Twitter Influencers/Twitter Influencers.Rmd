...
compute_bing_sentiment <- function(word_list, lexicon) {
  "Compute the Corpus Sentiment for a given Lexicon"
  
  # get bing sentiment
  word_list <- word_list %>% inner_join(lexicon) %>% select(word, n, sentiment) 
...
compute_bing_sentiment(clean, bing_lexicon)
...
Compute the sentiment of each word in a weighted fashion (_'positive'_ or _'negative'_)
